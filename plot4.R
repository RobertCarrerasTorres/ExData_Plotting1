...
plot(PowerCons$datatime, PowerCons$Voltage, type="l", xlab="datatime", ylab="Voltage")

plot(PowerCons$datatime, PowerCons$Global_reactive_power, type="l", xlab="datatime", ylab="Global_reactive_power")
